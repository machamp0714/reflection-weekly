...
- [ ] 1. プロジェクト基盤とInfrastructure層の設定管理を構築する
- [ ] 1.1 (P) TypeScript/Node.jsプロジェクトを初期化する
